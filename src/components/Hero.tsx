  ...
  return (
    <section className="bg-white py-12">
      ...
      <div className="relative w-full overflow-hidden mt-10 sm:mt-56"> 
        ...
        <div className="flex w-[120%] transform -translate-x-[5%] z-auto">
            <div className="flex-shrink-0 w-2/5 sm:w-1/5 px-2 max-h-48 sm:max-h-96 transform hover:scale-125 transition-transform duration-300 hover:z-50"><img src="src/assets/nails9.jpeg" alt="Nail Design 9" className="w-full h-full object-cover rounded-lg"/></div>
            <div className="flex-shrink-0 w-2/5 sm:w-1/5 px-2 max-h-48 sm:max-h-96 transform hover:scale-125 transition-transform duration-300 hover:z-50"><img src="src/assets/nails5.jpeg" alt="Nail Design 5" className="w-full h-full object-cover rounded-lg"/></div>
            <div className="flex-shrink-0 w-2/5 sm:w-1/5 px-2 max-h-48 sm:max-h-96 transform hover:scale-125 transition-transform duration-300 hover:z-50"><img src="src/assets/nails6.jpeg" alt="Nail Design 6" className="w-full h-full object-cover rounded-lg"/></div>
            <div className="flex-shrink-0 w-2/5 sm:w-1/5 px-2 max-h-48 sm:max-h-96 transform hover:scale-125 transition-transform duration-300 hover:z-50"><img src="src/assets/nails7.jpeg" alt="Nail Design 7" className="w-full h-full object-cover rounded-lg"/></div>
